...
const SAF_DEPRECATION_MESSAGE =
	'[bunmagic] SAF is deprecated and will be removed in v2.0.0. Use Bun.file()/Bun.write() and node:fs/promises APIs. See docs: https://bunmagic.com/migrations/saf-to-files';
