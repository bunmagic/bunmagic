...
export default async function setup() {
	...
	await check('Script sources are set up', async () => {
	...
	await check('PATH is correctly set up', async () => {
	...
	await check('Bun Magic is aliased to "bm"', async () => {
